...
description: "NASA WorldWind Java: open-source SDK for building 3D geospatial desktop apps with an interactive virtual globe rendered via OpenGL and JOGL on Java 11+."
---
...
```text title="WorldWind Object Graph"
