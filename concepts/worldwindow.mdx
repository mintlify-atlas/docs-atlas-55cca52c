---
title: "WorldWindow: The Core Rendering Interface"
sidebarTitle: "WorldWindow"
description: "WorldWindow is the central interface in WorldWind Java, providing the OpenGL rendering surface, model/view access, event dispatching, and GPU resource cache."
---
...
| `WorldWindowGLJPanel` | `javax.swing.JPanel` (lightweight Swing) | Layouts that require a Swing component hierarchy |
