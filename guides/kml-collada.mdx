...
Every feature extends `KMLAbstractFeature` and exposes `getName()`, `getDescription()`, `getVisibility()`, and `getAbstractView()` for camera positioning.
...
// Animate to a KML feature's AbstractView
KMLAbstractView view = placemark.getAbstractView();
if (view != null)
{
