...
description: "Use the WorldWind Configuration class to customize SDK behavior: file store paths, model class names, retrieval services, network settings, and OpenGL capabilities."
---
