...
description: "The WorldWind Model interface combines a Globe and LayerList. SceneController drives the render and pick loops. BasicModel and BasicSceneController are the default implementations."
---
