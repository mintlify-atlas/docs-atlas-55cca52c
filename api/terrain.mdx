---
title: "Terrain and Elevation Model API Reference"
...
<Tip>
Child models are queried in list order. Insert high-resolution regional models at a **low index** (high priority) so they take precedence over coarser global models when their coverage areas overlap.
</Tip>
...
terrain.setTimeout(30000L); // 30 seconds; 0 = wait indefinitely
...
for (int i = 0; i <= 100; i++) {
    ...
    double elev = terrain.getElevation(new Position(ll, 0));
