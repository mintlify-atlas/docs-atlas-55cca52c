...
description: "WorldWind singleton provides access to SDK global services: retrieval, file store, memory caches, task service, network status, and session cache."
---
